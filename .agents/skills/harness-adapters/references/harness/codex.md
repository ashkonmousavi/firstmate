...
Codex Stop hooks preserve exit status 2 and stderr to block, and expose `stop_hook_active`; the `--codex` guard rechecks ordinary and active-hook Stop firings until the persistent successor is verified.
