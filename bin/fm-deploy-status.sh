...
# the report is only what the captain owns, and why. Grouped by the design area the captain named,
# because a list of individual files is not a decision the captain can read.
