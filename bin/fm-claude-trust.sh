...
#
# When <project> is itself a linked worktree (a secondmate home spawned
# from, rather than as, the primary checkout), refusing outright would wedge
# a relaunch that is otherwise perfectly valid:
